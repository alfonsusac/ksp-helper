...
export const kcalbeloh: Package = {
  ...
  planets: {
    ...
    "Onrefni": {
      ...
      radius: 320_000, atmHeight: 0, soiHeight: 3_427_888.40885751, highestPoint: 0,
      geeASL: 0.3184,
    },
    "Rouqea": {
      image: "/kcalbeloh/rouqea.png", imageScale: 1.04,
      radius: 1_331_340, atmHeight: 80_000, soiHeight: 27_251_254.2938285, highestPoint: 0,
      mass: 3.342165E+23
    },
    "Iomena": {
      image: "/kcalbeloh/iomena.png", imageScale: 1.1,
      radius: 400_000, atmHeight: 80_000, soiHeight: 9_233_328.14499067, highestPoint: 0,
      geeASL: 0.35
    },
    "Uleg": {
    ...
    "Maelg": {
      ...
      radius: 6_185_000, atmHeight: 436_000, soiHeight: 11_622_940_000, highestPoint: 99_500_000, notLandable: true,
      mass: 1.1877E+27
    },
    "Mehtna": {
    ...
    "Simetra": {
      ...
      radius: 4_800_000, atmHeight: 190_000, soiHeight: 15_000_000, highestPoint: 0, notLandable: true,
      mass: 3.5648E+24,
    },
    "Simeht": { // Simetra's twin
      image: "/kcalbeloh/simeht.png", imageScale: 1.05,
      radius: 4_000_000, atmHeight: 177_000, soiHeight: 12_000_000, highestPoint: 0, notLandable: true,
      mass: 2.1645E+24
    },
    ...
    "Noi": { // Sunorc's planet
      ...
      radius: 8_300, atmHeight: 0, soiHeight: 846_000, highestPoint: 0,
      mass: 1.73E17
    },
    ...
    "Aralc-B": {
      ...
      radius: 22_832_000, atmHeight: 436_000, soiHeight: 5_600_000_000, highestPoint: 0, notLandable: true,
      mass: 6.50e+27,
    },
