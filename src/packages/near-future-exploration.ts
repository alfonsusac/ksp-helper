...
export const nearfutureexpansion: Package = {
  ...
  antennas: {
    "nefx-ax-04": {
      label: "C0+ AX-04 Pointable Helical Antenna",
      image: "/nfe/antenna/ax04.png",
      type: "direct", rating: 40_000, combinabilityExponent: 0.5,
    },
    "nefx-ax-05": {
      label: "C0+ AX-05 Aerial Micro-Antenna",
      image: "/nfe/antenna/ax05.png",
      type: "direct", rating: 150_000, combinabilityExponent: 0.75,
    },
    "nefx-ph-1": {
      label: "C0+ PH-1 Phased Array Antenna Element",
      image: "/nfe/antenna/ph1.png",
      type: "direct", rating: 125_000, combinabilityExponent: 1,
    },
    "nefx-ph-2": {
      label: "C0+ PH-2 Phased Array Antenna Element",
      image: "/nfe/antenna/ph2.png",
      type: "direct", rating: 200_000, combinabilityExponent: 1,
    },
    "nefx-ax-30": {
      label: "C0++ AX-30 High Gain Micro-Antenna",
      image: "/nfe/antenna/ax30.png",
      type: "direct", rating: 300_000, combinabilityExponent: 0.75
    },
    "nefx-dr01": {
      label: "C0++ DR-1 High Gain Antenna",
      image: "/nfe/antenna/dr01.png",
      type: "direct", rating: 300_000, combinabilityExponent: 0.75
    },
    "nefx-dr-3": {
      label: "C1 DR-3 Deployable High Gain Antenna",
      image: "/nfe/antenna/dr3.png",
      type: "direct", rating: 500_000, combinabilityExponent: 0.75,
    },
    "nefx-ph-3": {
      label: "C1+ PH-3 Phased Array Antenna Element",
      image: "/nfe/antenna/ph3.png",
      type: "direct", rating: 800_000, combinabilityExponent: 1,
    },
    "nefx-ra-00-2": {
      label: "C1++ RA-00-2 Micro-Relay Antenna",
      image: "/nfe/antenna/ra002.png",
      type: "relay", rating: 2_000_000, combinabilityExponent: 0.75
    },
    "nefx-d2": {
      label: "C1++ Spot Antenna D-2",
      image: "/nfe/antenna/d2.png",
      type: "direct", rating: 2_000_000, combinabilityExponent: 0.75
    },
    "nefx-gra-x1": {
      label: "C2+ GRA-X1 Phased Relay Antenna",
      image: "/nfe/antenna/grax1.png",
      type: "relay", rating: 6_000_000, combinabilityExponent: 0.25
    },
    "nefx-gra-x2": {
      label: "C2+ GRA-X2 Phased Relay Antenna",
      image: "/nfe/antenna/grax2.png",
      type: "relay", rating: 10_000_000, combinabilityExponent: 0.25
    },
    "nefx-d50": {
      label: "C2+ Large Spot Antenna D-50",
      image: "/nfe/antenna/d50.png",
      type: "direct", rating: 50_000_000, combinabilityExponent: 0.75
    },
    "nefx-ra08": {
      label: "C2+ RA-0-8 Relay Antenna",
      image: "/nfe/antenna/ra08.png",
      type: "relay", rating: 85_000_000, combinabilityExponent: 0.75
    },
    "nefx-grax3": {
      label: "C2++ GRA-X3 Phased Relay Antenna",
      image: "/nfe/antenna/grax3.png",
      type: "relay", rating: 100_000_000, combinabilityExponent: 0.25
    },
    "nefx-ra5b": {
      label: "C2++ RA-5B Advanced Relay Antenna",
      image: "/nfe/antenna/ra5b.png",
      type: "relay", rating: 500_000_000, combinabilityExponent: 0.75
    },
    "nefx-fda": {
      label: "F-DA Direct Antenna Feed",
      image: "/nfe/antenna/fda.png",
      type: "direct", rating: 5_000, combinabilityExponent: 0.5,
    },
    "nefx-fra": {
      label: "F-RA Relay Antenna Feed",
      image: "/nfe/antenna/fra.png",
