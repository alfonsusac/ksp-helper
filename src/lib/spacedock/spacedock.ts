...
export type UserRequiredError = 'You are not logged in.' // user_required()
...
export type Error<T extends string> = { error: true, reason: T }
export type NoError = { error: false }
export type Result<Ok, Err extends string> = Error<Err> | Ok

const not_authenticated = { error: true, reason: 'You are not logged in.' }
